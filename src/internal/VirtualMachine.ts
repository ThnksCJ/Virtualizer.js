...
/**
 * The virtual machine is responsible for executing the instructions
 * generated by the interpreter, or written by the user.
 *
 * @see Interpreter
 */
export default class VirtualMachine {
    /**
     * The local variables of the virtual machine, used for
     * storing variables and their values
     */
    private readonly locals: Record<string, any>;
    /**
     * The stack of the virtual machine, used for storing intermediate values
     * and results of operations, such as arithmetic operations
     */
    private readonly stack: any[];
    /**
     * The current position in the instruction array
     */
